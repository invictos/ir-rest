...
public class PatientEntity extends UserEntity {
    ...
    public PatientEntity(@NonNull String prenom, @NonNull String nom, @NonNull String password, @NonNull Adresse adresse, @NonNull String nss, @NonNull Banque banque) {
    ...
    public PatientDTO toDTO() {
        return new PatientDTO(getId(), getPrenom(), getNom(), getAdresse(), getNss(), getBanque(), getRole());
    }
}
