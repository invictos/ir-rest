...
public abstract class ARemboursable extends CPAMEntity implements ToDTO<ARemboursableDTO> {
    ...
    @Override
    public ARemboursableDTO toDTO(){
        return new ARemboursableDTO(getPrix(), getTauxCPAM(), getRemboursement());
    }
